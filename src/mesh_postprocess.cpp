// Mesh postprocess chain for the textured GLB export: weld hairline
// cracks, unify face winding, drop floating fragments, Taubin smoothing,
// fan hole filling, xatlas unwrap with the trilinear voxel-PBR bake and
// Telea inpaint.  Adapted from pwilkin/trellis.cpp 2516c48b (MIT); the
